...
public class CsvWriter implements Pipe {
    ...
    public void dataFlow(Object data) throws IOException {
        ...
        while (elements.hasNext()) {
            ...
            String postalCode = feature.get("postalCode").asText().replaceAll(","," ");;
            ...
            printer.printRecord(title, categoryName, address, street, city, countryCode, website, phone, location.toString(), plusCode, postalCode, totalScore, reviewsCount);
        }
